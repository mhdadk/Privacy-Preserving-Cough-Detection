...
% get the first and last indices of the windows

window_start = 1 : step_size : length(x) - window_length + 1;
window_end = window_start + window_length - 1;

% to record the labels
...
for i = 1 : step_size : length(x) - window_length + 1
    ...
    [cough_rel_start,cough_rel_end] = compute_cough_ind(window);
